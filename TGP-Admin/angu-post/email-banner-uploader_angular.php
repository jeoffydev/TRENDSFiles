<?php
   ...
   //Required for authorization
    ...
    $pathUrl1 = $serverPath.'/Downloads-folder/email/'; 
    ...
    if($request->option == 3){  
        $url = $request->url;
        $jsonCreate = array('url'=> $url);
        $fp = fopen($pathUrl1.'emailbanner.json', 'w');
        fwrite($fp, json_encode($jsonCreate, JSON_PRETTY_PRINT));   // here it will print the array pretty
        fclose($fp);
        echo "1";
    }
