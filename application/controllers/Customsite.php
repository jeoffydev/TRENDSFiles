...
class Customsite extends CI_Controller {
	...
	{
		$pageTitle = 'TRENDS |  Custom Website Editor';
		...
		if(count($customArray['themeArray']) == 0 && $this->siteLogcheck['loggedIn'] == 1 &&  $this->siteLogcheck['userDatas'][0]->skinnedWebsites == 1 ):
			/* loggedin datas */  
			...
			/*$customsiteDatas = $this->customsite_model->getCustomersTheme($CustomerNumber, $CustomerName, $themeMax); 
			...
			$data['customsiteDatas'] = $customsiteDatas; */
			...
			/* loggedin datas */
			 ...
			 $this->load->view('customsite', $data);
		else: 
			redirect('/'); 
		endif;	
