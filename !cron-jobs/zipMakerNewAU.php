<?php
	...
	$query1 = "SELECT Code, Status, ImageCount, Active FROM ".$tableItems." WHERE Active != 0 AND Status NOT LIKE 'D' ORDER BY Code";
	...
	$oldFile1 = "/Images/ProductsAU.zip";
	$newFile1 = "/Images/ProductsAU-New.zip";
	...
	//if true, good; if false, zip creation failed
	$oldFile2 = "/Images/New-ProductsAU.zip";
	$newFile2 = "/Images/New-ProductsAU-New.zip";
