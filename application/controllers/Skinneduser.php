...
class Skinneduser extends CI_Controller {
	...
	{
		$pageTitle = 'TRENDS |  Custom Website User Management';
		...
		if(count($customArray['themeArray']) == 0 && $this->siteLogcheck['loggedIn'] == 1 &&  $this->siteLogcheck['userDatas'][0]->customSiteUser == 1 ):
			/* loggedin datas */  
			...
			/* loggedin datas */
			 ...
			 $this->load->view('skinneduser', $data);
		else: 
			redirect('/'); 
		endif;	
