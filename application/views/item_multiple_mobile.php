...
<!-- MOBILE TABS ACCORDION ****************************************************************************************************************** --> 
			...
			<div class="card-header" id="headingTwoM">
					...
					<div id="accordion" class="mobile-item-accordion  mobile-only">
						<div class="card">
							<div class="card-header" id="headingOne">
							 
								<button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" ng-click="getQuickViewData('details', '<?=$productItem[0]->Prim?>', '<?=$productItem[0]->Code?>')">
									<i class="fa fa-plus"></i> Details
								</button>
						...
						<div class="card">
							<div class="card-header" id="headingTwo">
								...
								<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" ng-click="getQuickViewData('stock', '<?=$productItem[0]->Prim?>', '<?=$productItem[0]->Code?>', 'item')" >
									<i class="fa fa-plus"></i> Stock
								</button>
...
<!-- MOBILE TABS ACCORDION ****************************************************************************************************************** --> 				
			...
			<div class="col-md-1 icons-sidebar">
